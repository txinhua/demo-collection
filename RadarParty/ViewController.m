...
//    self.xcodeImageView.transform = CGAffineTransformRotate(self.xcodeImageView.transform, degreesToRadians(-angle));
//}

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor blackColor];    
//    [self performSelector:@selector(stopAnimation) withObject:nil afterDelay:15];
}
...
- (void)startAnimation
{
    ...
    [self.theImage.layer addAnimation:theAnimation forKey:@"transform"];
}
