...
- (void)setState:(kUICC_EGOPullRefreshState)aState {
	...
	switch (_state) {
		case kUICC_EGOPullRefreshPulling: { // {{{
			...
			[self.textLabel setText:NSLocalizedString(@"LCFreeMeYouGetMore",@"")];
		...
		case kUICC_EGOPullRefreshNormal: { // {{{
            ...
            [self.textLabel setText:NSLocalizedString(@"LCUpMeYouGetMore",@"")];// Pull up to load more...
		...
		case kUICC_EGOPullRefreshLoading: { // {{{
            ...
            [self.textLabel setText:NSLocalizedString(@"LCLoading...",@"")];// Loading...
        ...
        case kUICC_EGOPullRefreshLoaded: {
            [self.textLabel setText:NSLocalizedString(@"LCLoaded",@"")];// Loading...
			[self.activityIndicatorView stopAnimating];
            self.customImgView.hidden = YES;
        }// }}}
        case kUICC_EGOPullLoadMoreClose: {
            [self.textLabel setText:NSLocalizedString(@"LCNowWithoutMore",@"")];
            [self.activityIndicatorView stopAnimating];
            self.customImgView.hidden = YES;
        }
		default:
